  ...
  if (count($pesanError)>=1 ){
   ...
   $kode	= $_POST['txtKode'];
		...
		$mySql	= "UPDATE surat  SET 
						...
						pic='$txtPic', itso_head='$txtItso', head_helpdeks='$txtHead', permasalahan='$txtPermasalahan', keterangan='$txtKeterangan', solusi='$txtSolusi', status='$txtStatus'
				  WHERE id='$kode'";		
...
$dataKode		= $myData['id'];
  ...
  $dataItso   = isset($_POST['txtItso']) ? $_POST['txtItso'] : $myData['itso_head'];
  $dataHead   = isset($_POST['txtHead']) ? $_POST['txtHead'] : $myData['head_helpdeks'];
...
<form action="" method="post" name="form1" enctype="multipart/form-data" target="_self">
  <table class="table-list" width="700" border="0" cellspacing="1" cellpadding="3">
    ...
    <tr>
      <td><b>ITSO HEAD </b></td>
      <td><b>:</b></td>
      <td><input name="txtItso" type="text" value="<?php echo $dataItso; ?>" size="30" maxlength="30" /></td>
    </tr>
    <tr>
      <td><b>Dept. Head IT Support Technical </b></td>
      <td><b>:</b></td>
      <td><input name="txtHead" type="text" value="<?php echo $dataHead; ?>" size="30" maxlength="30" /></td>
    </tr>
    <tr>
