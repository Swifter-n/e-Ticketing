...
<script>
  ...
  var greeting = ("<h5>Selamat " +display+ ", <?php echo $_SESSION['teknisi'];?></h5>");
...
<ul class="ca-menu">
                    ...
                    <li>
                        <a href="update-teknisi.php">
                            <span class="ca-icon"><img src="images/note.png"></span>
                            <div class="ca-content">
                                <h2 class="ca-main">Update Ticketing</h2>
                                <h3 class="ca-sub">Update Data Ticket</h3>
                            </div>
                        </a>
                    </li>
