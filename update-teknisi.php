...
.button{
  ...
  <div>
      <h1 align="center"><b>UPDATE DATA TICKET </b></h1>
      </div>
      <div class="find">
      ...
      <div class="container">
        ...
        <thead>
          <tr>
            ...
            <th scope="col"><strong>Tools</strong></th>
  ...
  ?>    <tbody>
          <tr>
            ...
            <td><a href="edit-teknisi.php?kode=<?php echo $kode; ?>" target="_self" alt="Edit Data">Edit</a></td>
          </tr> 
        <?php } ?>
        </tbody>
        </table>
